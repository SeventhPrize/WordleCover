...
class WordleCoverFinder:
    ...
    def solve_wordle(self):
        ...
        return self.max_clique(self.adj_mat, TARGET_CLIQUE_SIZE) # call max_clique iterations

    def max_clique(self, adj_mat, target_clique_size):
        '''
        ...
        for candidate_word in adj_mat.index:
            ...
            if adj_vec.sum() > 0:
                ...
                clique = self.max_clique(sub_adj_mat, target_clique_size=target_clique_size-1)
...
plt.xscale('log')
plt.title('Max Clique Algorithm after Presorting')
